 ...
 *
 */
class BrandAdminUserMiddleware
{
    ...
    {
        if ($request->get('user')->type !== User::USER_TYPE_SUPER &&
            $request->get('user')->type !== User::USER_TYPE_ADMIN &&
            $request->get('user')->type !== User::USER_TYPE_BRAND_ADMIN) {
